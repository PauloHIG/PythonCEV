...
def CeV():
    ...
    )  # olha o esquema aí para eliminar todos os espaços na contagem
    print(
        "Seu primeiro nome tem {} letras".format(nome.find(" "))
    )  # ao encontrar a posição do primeiro ' ' a contagem para, a posição do espaço equivale à quantidade de letras da primeira palavra
