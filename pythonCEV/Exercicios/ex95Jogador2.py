...
for ender,dicio in enumerate(time):#o enumerate coloca o id(endereço) da lista e o seu elemento
	...
	for valores in dicio.values():
		print(f'{str(valores):<16}',end='')#esse str(valores) resolveu um problema sério, não posso usar o fatiamento se o valor for uma lista, então converto-a para string
