...
from validados import (
    recNome,
    recIdade,
)  # validados é a biblioteca que valida diversos tipos de dados, foi feita para estudar mas pode vir a ser bem util pra outras coisas
...
while opc != 3:
    ...
    if opc == 1:
        ...
        escreve_dado(
            "dados", recNome("Digite o nome da pessoa: "), recIdade("Digite a idade da pessoa: "),
        )
    else:
