...
if escolha == 1:
    ...
    cadaParcela = (preço / parcelas) + (
        (preço / parcelas) / 5
    )  # a divisão por 5 é uma maneira de calcular 20%, os calculos precisam ser feitos com o preço dividido pelo número de parcelas
