...
def CeV():
	...
	print(n)
	u = n//1 % 10 #a chave pra entender como isso funciona é lembrar que o resto de uma divisão por 10 sempre vai ser a unidade
	d = n//10 % 10 #para o número da dezena se tornar o da unidade e virar o resto da divisão por 10, é preciso dividir o numero por 10
	c = n//100 % 10 #o mesmo vale para os outros, a centena irá virar a unidade para virar o resto da divisão por 10, por exemplo, 3245//10 = 32, 32%10 = 2
